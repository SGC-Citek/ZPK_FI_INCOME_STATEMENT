CLASS zcl_fi_income_statement DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC.
...
CLASS ZCL_FI_INCOME_STATEMENT IMPLEMENTATION.


  METHOD if_rap_query_provider~select.
    CASE io_request->get_entity_id( ).
      WHEN 'ZC_FI_INCOME_STATEMENT'.
        DATA: lt_data_response TYPE TABLE OF zc_fi_income_statement.
        ...
        zcl_fi_income_statement_manage=>get_instance( )->get_data(
